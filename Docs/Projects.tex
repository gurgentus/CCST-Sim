...
%
%\begin{frame}
%\frametitle{What do mathematicians do all day?}
%\pause
%
%\begin{columns}[c]
%\column{2in}
%
%\includegraphics[height=3in]{coffee.jpg}
%
%\pause
%
%\column{2.5in}
%
%\begin{itemize}
%\item Solve mathematical puzzles and create new ideas (`tools') to solve math puzzles
%\pause
%\item Share with students the classical tools to solve mathematical puzzles
%\pause
%\item Share with other researchers new tools to solve mathematical puzzles
%\end{itemize}
%
%\end{columns}
%
...
%
%
%Use maths to solve puzzles and teach others how to solve puzzles and tools to solve puzzles.
%
%\end{frame}
